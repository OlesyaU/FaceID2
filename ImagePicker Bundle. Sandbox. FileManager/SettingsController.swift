...
class SettingsController: UITableViewController {
    ...
    static let defaultSetttings = SettingsController()
    var new: ((_ selectedSegment: Int)-> Void)?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            let act = UIAction {  _ in
                TableController.sort = 1
            }
            let act0 = UIAction {_ in
                TableController.sort = 0
            }
            segment.setAction(act0, forSegmentAt: 0)
            segment.setAction( act, forSegmentAt: 1)
            segment.setTitle("<", forSegmentAt: 0)
